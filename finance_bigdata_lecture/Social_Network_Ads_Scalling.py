...
input_file = "data/Social_Network_Ads.csv"
...
df_standard_scaled.to_csv(output_file, encoding="utf-8")
...
df_minmax_scaled.to_csv(output_file, encoding="utf-8")
# 5. 스케일링 결과 시각화
