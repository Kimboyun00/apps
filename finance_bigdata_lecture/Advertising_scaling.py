...
df = pd.read_csv("data/outlier_removed.csv", index_col=0, encoding="cp949")
...
df_standard_scaled.to_csv('data/Advertising_standard_Scaled.csv')
...
df_minmax_scaled.to_csv('data/Advertising_minmax_Scaled.csv')
# 5. 스케일링 결과 시각화
